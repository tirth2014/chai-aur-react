...
function App() {
  ...
  return (
    // <div className='w-full '>
      <div className="w-full h-screen flex flex-col justify-center items-center max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500">
